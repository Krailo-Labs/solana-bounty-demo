...
*   🧠 **Cloudflare AI Gateway & Worker Endpoint:** The application comes pre-configured with a live, custom Edge AI endpoint (`https://solana-ai.krailo.sh`). It routes queries exclusively through Cloudflare's AI Gateway. This provides:
...
*   💬 **Integrated AI Chat & Presets:** To overcome the "blank canvas" paralysis beginners often face, the AI assistant includes **tailored preset questions** (e.g., "How do I start?", "Is it safe?") to guide their learning journey naturally. If the custom endpoint is removed, it gracefully falls back to a zero-latency local knowledge base.
