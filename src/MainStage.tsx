...
const stateDurations: Record<AppState, number> = {
  [AppState.INTRO]: 10000,
  [AppState.BANK_SIMPLE]: 9000,
  [AppState.BANK_CHECK]: 9000,
  [AppState.BANK_INSTITUTION]: 9000,
  [AppState.BANK_FEE]: 8000,
  [AppState.BANK_WAIT]: 8500,
  [AppState.BANK_HUMAN]: 7500,
  [AppState.BANK_RECEIVED]: 3750,
  [AppState.HOOK]: 7500,
  [AppState.BLOCKCHAIN_INTRO]: 8500,
  [AppState.SOLANA_REVEAL]: 8500,
  [AppState.SOLANA_SPEED]: 8000,
  [AppState.SOLANA_FEE]: 8000,
  [AppState.SOLANA_SMART_CONTRACTS]: 9000,
  [AppState.SOLANA_DEFI]: 9000,
  [AppState.SOLANA_NFT]: 9000,
  [AppState.FINAL_REVEAL]: 9000,
